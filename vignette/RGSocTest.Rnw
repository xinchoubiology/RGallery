...
<<fastsmallsize-t, echo=FALSE, fig.cap="glmnet time consuming from 100 to 15,000">>=
...
<<glmnet_fig, echo=FALSE, eval=TRUE, fig.cap="glment time ~ data size">>=
library(ggplot2)
...
\section{Conclusion}
In this \code{RGallery} package, I have completed the three questions given on SAG project's homepage. Therefore, I think I can meet mentors requirements and I wish I could work with you for the SAG project!
